...
?>
<!DOCTYPE html>
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="assets/" data-template="ujamaatech">
    <head>
        <meta charset="utf-8" />
                    ...
                    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                        ...
                        <ul class="menu-inner py-1">
                            ...
                            <li class="menu-item active">
                                <a href="mainfunction" class="menu-link">
                            ...
                            <li class="menu-item">
                                <a href="mainfunction" class="menu-link">
                                    ...
                                    <div data-i18n="Analytics">Upload News</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="posts" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-detail"></i>
                                    <div data-i18n="Analytics">Upload Records</div>
                                </a>
                            </li>
                        </ul>
                    </aside>
