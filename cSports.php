    ...
    <div class="container">
        ...
        <div class="row justify-content-lg-between">
            <div class="col-lg-8 col-md-8">
                ...
                $query = "SELECT * FROM uploads where HEADING LIKE '%$text%' AND CATEGORIES = 'sports' AND APPROVE = 'OK' ORDER BY UP_ID DESC";
                ...
                <div class="single-job-items mb-30">
                    <div class="row">
                        <div class="col-lg-4">
                            <a href="cSports?id='.urlencode(base64_encode($row['UP_ID'])).'&action=Move"><img src="assets/img/post/'.$row['IMAGES'].'" class="img-fluid" alt=""></a>
                        </div>
                        <div class="col-lg-8">
